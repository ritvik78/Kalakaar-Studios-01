...
<button type="submit" disabled={status === 'submitting'} className="rounded-full bg-gradient-to-r from-purple-700 via-purple-500 to-violet-400 px-5 py-3 text-sm font-semibold text-white transition hover:scale-[1.01] disabled:opacity-60">
{status === 'submitting' ? 'Sending...' : 'Send inquiry'}
</button>
{status === 'success' ? <p className="text-sm text-violet-200">Inquiry received. We&apos;ll reply with next steps soon.</p> : null}
