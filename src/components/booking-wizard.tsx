...
if (submitted) {
return (
<div className="rounded-[2rem] border border-purple-300/30 bg-white/10 p-8 text-center text-white shadow-glass backdrop-blur-xl">
<div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-violet-500 to-purple-700 text-white shadow-glow">
...
<div className="h-full rounded-full bg-gradient-to-r from-violet-400 via-purple-500 to-violet-400 transition-all duration-300" style={{ width: `${progress}%` }} />
</div>
</div>
...
{step < steps.length - 1 ? (
<button type="button" onClick={next} className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-purple-700 via-purple-500 to-violet-400 px-5 py-3 text-sm font-semibold text-white">
Next <ArrowRight className="h-4 w-4" />
</button>
) : (
<button type="submit" disabled={status === 'submitting'} className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-purple-700 via-purple-500 to-violet-400 px-5 py-3 text-sm font-semibold text-white disabled:opacity-60">
