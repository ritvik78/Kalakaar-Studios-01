...
return (
<section className="relative isolate overflow-hidden border-b border-purple-200 bg-[linear-gradient(135deg,#FAFAFF,#F5F3FF_52%,#EEF2FF)] py-16 sm:py-20 lg:py-24">
<div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(147,51,234,0.08),transparent_35%),radial-gradient(circle_at_bottom_right,rgba(168,85,247,0.08),transparent_30%)]" />
<PageShell className="relative grid gap-10 lg:grid-cols-[1fr_0.8fr] lg:items-end">
<div>
<TagPill>{eyebrow}</TagPill>
<h1 className="mt-6 font-display text-4xl font-black uppercase leading-[0.95] tracking-[-0.04em] text-[#1a1a2e] sm:text-5xl lg:text-7xl">{title}</h1>
...
<h3 className="font-display text-2xl font-black text-[#1a1a2e]">{title}</h3>
