    ...
    <section className="py-16">
      <PageShell>
        <div className="max-w-3xl">
          <p className="mb-3 inline-flex rounded-full border border-white/20 bg-white/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.28em] text-yellow-200 backdrop-blur-md">Talent categories</p>
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {categories.map((category) => {
            ...
            return (
              <GlassCard key={category.slug} className="p-5">
